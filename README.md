...
```javascript
 {
    "dev": {
        ...
        "runtime": "python2.7", // Python runtime to use on Lambda. Can be one of "python2.7" or "python3.6" or "python3.7". Defaults to whatever the current Python being used is.
